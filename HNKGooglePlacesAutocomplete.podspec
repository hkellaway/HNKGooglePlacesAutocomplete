Pod::Spec.new do |s|
  ...
  s.subspec 'Models' do |ss|
    ss.source_files = 'Pod/Classes/HNKGooglePlacesAutocompleteModel.{h,m}', 'Pod/Classes/HNKQueryResponsePredictionMatchedTerm.{h,m}', 'Pod/Classes/HNKQueryResponsePredictionTerm.{h,m}'
  end
