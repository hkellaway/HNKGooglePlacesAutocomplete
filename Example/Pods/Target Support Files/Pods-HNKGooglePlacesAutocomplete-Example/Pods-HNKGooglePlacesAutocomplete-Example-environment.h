...
#define COCOAPODS_VERSION_MINOR_HNKGooglePlacesAutocomplete 6
...
#define COCOAPODS_VERSION_MINOR_HNKGooglePlacesAutocomplete_Models 6
...
#define COCOAPODS_VERSION_MINOR_HNKGooglePlacesAutocomplete_Models_Networking 6
