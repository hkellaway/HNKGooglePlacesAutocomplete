...
#define COCOAPODS_VERSION_MINOR_HNKGooglePlacesAutocomplete 7
...
#define COCOAPODS_VERSION_MINOR_HNKGooglePlacesAutocomplete_Models 7
...
#define COCOAPODS_VERSION_MINOR_HNKGooglePlacesAutocomplete_Models_Networking 7
